"""
This example file fetches a text file of Alice in Wonderland by Lewis Carroll from the web 
and saves it to a local file named aliceinwonderland.txt in a folder named example_data.
...
def main():
    ...
    """
    txt_url = 'https://www.gutenberg.org/cache/epub/11/pg11.txt'
    logger.info("Starting text fetch demonstration...")
    fetch_txt_file(FETCHED_DATA_DIR, "aliceinwonderland.txt", txt_url)
