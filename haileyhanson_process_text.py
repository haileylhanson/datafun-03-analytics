"""
Process a text file to count occurrences of the word "mad" and save the result.
"""
...
def process_text_file():
    """Read a text file, count occurrences of 'mad', and save the result."""
 
    input_file = pathlib.Path(FETCHED_DATA_DIR, "aliceinwonderland.txt")

    output_file = pathlib.Path(PROCESSED_DIR, "mad_word_count.txt")

    word_to_count: str = "mad"
