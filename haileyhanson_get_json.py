...
def main():
    ...
    """
    json_url = 'https://raw.githubusercontent.com/sharmadhiraj/free-json-datasets/refs/heads/master/datasets/world-population-by-country-2020.json'
    logger.info("Starting JSON fetch demonstration...")
    fetch_json_file(FETCHED_DATA_DIR, "countries_data.json", json_url)
